...
import { Table, FileSpreadsheet, Download, AlertCircle } from 'lucide-react';
...
export default function Results() {
  ...
  const handleGetReport = async (e) => {
    ...
    if (!reportFilters.reportType) {
      setReportError("لطفاً ابتدا نوع گزارش را مشخص فرمایید.");
      return;
    }
    ...
    try {
      ...
      let filename = `superadmin_report_${reportFilters.reportType}.xlsx`;
      ...
      setReportError(error.message || "خطا در دریافت فایل اکسل");
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div>
            <h2 className="font-black text-base sm:text-lg mb-1">جداول رتبه‌بندی هنرآموزان</h2>
            <p className="text-xs opacity-80">مشاهده امتیازات و کارنامه‌های کلی پایه‌ها</p>
          </div>
        ...
        >
          <div>
            <h2 className="font-black text-base sm:text-lg mb-1">خروجی هوشمند اکسل</h2>
            <p className="text-xs opacity-80">تولید فایل گزارش از کلیه شاخص‌ها با فیلتر دقیق</p>
          </div>
      ...
      {activeTab === 'tables' && (
        <RokadCard
          title="رتبه‌بندی پایه‌ها"
          subtitle="امتیازات آموزشی، فردی، شغلی و انضباطی به تفکیک پایه"
      ...
      {activeTab === 'reports' && (
        <RokadCard
          title="دریافت فایل تفصیلی اکسل"
          subtitle="فیلترگذاری دقیق بر اساس تاریخ، پایه و وضعیت گزارش"
          badge="گزارش ساز"
          persona="female"
        >
          <form onSubmit={handleGetReport} className="space-y-6 mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="">همه هنرآموزان</option>
            ...
            <div className="flex justify-end pt-2">
              ...
              >
                ...
                {submittingReport ? 'در حال آماده‌سازی فایل اکسل...' : 'دانلود گزارش اکسل'}
              </RokadButton>
            </div>
          </form>
        </RokadCard>
