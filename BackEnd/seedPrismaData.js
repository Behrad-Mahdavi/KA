  ...
  try {
    ...
    const usersData = [
      ...
      },
      {
        ...
        class: 102,
        fieldOfStudy: 'تولیدکننده چندرسانه‌ای',
        password: bcryptjs.hashSync('s2222222231', 10),
        score: 175,
        token: Math.floor(175 * 0.95)
      },
      {
        fullName: 'نرگس کریمی',
        idCode: '2222222225',
      ...
      },
      {
        ...
        class: 202,
        fieldOfStudy: 'تولیدکننده چندرسانه‌ای',
        password: bcryptjs.hashSync('s2222222232', 10),
        score: 240,
        token: Math.floor(240 * 0.95)
      },
      {
        fullName: 'پویا صادقی',
        idCode: '2222222228',
      ...
      },
      {
        ...
        class: 302,
        fieldOfStudy: 'تولیدکننده چندرسانه‌ای',
        password: bcryptjs.hashSync('s2222222233', 10),
        score: 285,
        token: Math.floor(285 * 0.95)
      }
    ];
